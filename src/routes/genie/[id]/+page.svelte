<svelte:head>
	<title>{wish?.title || 'Genie Wish'} · Jelly-Claw</title>
	<meta name="description" content={wish?.result?.slice(0, 160) || 'A Genie wish on Jelly-Claw'} />
</svelte:head>
...
<style>
	...
	.link-btn {
		...
		color: #8aa9f5;
		padding: 8px 16px;
		border: 1px solid rgba(138,169,245,0.2);
		border-radius: 8px;
		text-decoration: none;
		background: rgba(138,169,245,0.04);
	}
